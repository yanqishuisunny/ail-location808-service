package com.ail.location.model.entity;
...
//    @TableField("expiration")
    @TableField(value = "expiration",validate= FieldStrategy.IGNORED)
     ...
     * 设备激活时间
     */
//    @TableField("device_activation_time")
    @TableField(value = "device_activation_time",validate= FieldStrategy.IGNORED)
     ...
     * 安装位置照片
     */
//    @TableField("install_position_url")
    @TableField(value = "install_position_url",validate= FieldStrategy.IGNORED)
    private String installPositionUrl;

    /**
     * 安装车辆照片
     */
//    @TableField("install_car_url")
    @TableField(value = "install_car_url",validate= FieldStrategy.IGNORED)
